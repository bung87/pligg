...
function show_profile() {
	global $user, $main_smarty, $the_template, $CSRF,$language;//add language by bung
	...
	$main_smarty->assign('user_language', !empty($user->language) ? $user->language : $language);//change defualt 'english' to $language by bung
	...
	$main_smarty->assign('user_total_saved', $user->total_saved);//add by bung
