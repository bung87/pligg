...
$lang_conf=lang_loc . '/modules/status/lang_'.pligg_language.'.conf';
if(!file_exists($lang_conf)){define('status_lang_conf', lang_loc . '/modules/status/lang.conf');}
else{define('status_lang_conf', $lang_conf);}//modified by bung
