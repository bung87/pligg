...
$lang_conf=lang_loc . '/modules/simple_messaging/lang_'.pligg_language.'.conf';
if(!file_exists($lang_conf)){define('simple_messaging_lang_conf', lang_loc . '/modules/simple_messaging/lang.conf');}
else{define('simple_messaging_lang_conf', $lang_conf);}//modified by bung
