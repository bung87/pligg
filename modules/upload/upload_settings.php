...
$lang_conf=lang_loc . '/modules/upload/lang_'.pligg_language.'.conf';
if(!file_exists($lang_conf)){define('upload_lang_conf', lang_loc . '/modules/upload/lang.conf');}
else{define('upload_lang_conf', $lang_conf);}
define('upload_lang_conf', lang_loc . '/modules/upload/lang_'.pligg_language.'.conf');
