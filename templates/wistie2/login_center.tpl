...
<form id="thisform" method="post">
	...
	<form action="{$URL_login}" method="post">	
		<strong>{#PLIGG_Visual_Login_Username#}:</strong><br />
			<input type="text" name="username" class="input-medium" value="{if isset($login_username)}{$login_username}{/if}" tabindex="10" /><br />
		<br /><strong>{#PLIGG_Visual_Login_Password#}:</strong><br />
			<input type="password" name="password" class="input-medium" tabindex="11" /><br />
...
<form action="{$URL_login}" id="thisform2" method="post">
	...
	<p>{#PLIGG_Visual_Login_EmailChangePass#}</p>
		...
		<input type="text" name="email" class="input-medium" size="25" tabindex="14" id="forgot-email" value="" />
		<br /><br />
