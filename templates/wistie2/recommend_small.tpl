...
<fieldset><legend>{#PLIGG_Visual_Recommend_FormTitle#}<a class="pull-right close" href="#" onclick="$('#emailto-{$link_shakebox_index}').hide();return false;">&times;</a></legend>
	<form name="email_to" method="get" action="{$my_base_url}{$my_pligg_base}/recommend.php">
		...
		<div class="input-prepend">
            ...
            <input type="text" class="input-medium" name="email_address_1" size="35" id="email_address_1_{$link_shakebox_index}" value="">
            </div>
		<div class="input-prepend">
              <span class="add-on"><i class="black icon-envelope"></i></span>
           <input type="text" class="input-medium" name="email_address_2" size="35" id="email_address_2_{$link_shakebox_index}" value="">
            </div>
			<div class="input-prepend">
             <span class="add-on"><i class="black icon-envelope"></i></span>
         <input type="text" class="input-medium" name="email_address_3" size="35" id="email_address_3_{$link_shakebox_index}" value="">
            </div>
