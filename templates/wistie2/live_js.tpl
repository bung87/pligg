...
function to_html(data) {ldelim}
	...
	if (data.type == 'problem')
		...
		html += '<div class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_unpublished.php">'+'{#PLIGG_Visual_Submit_A_New_Story#}'+'</a></strong></div>';
	else if (data.type == 'published')
		html += '<div class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_published.php">'+'{#PLIGG_Visual_Published_News#}'+'</a></strong></div>';	
	else if (data.type == 'comment')
		html += '<div class="live2-type"><strong><a href="<?php echo my_pligg_base; ?>/live_comments.php">'+'{#PLIGG_Visual_Comment_Submit#}'+'</a></strong></div>';
	else if(data.type== 'vote')
		html += '<div class="live2-type">'+'{#PLIGG_Visual_Pligg_For_Stories#}'+'</div>';	
	else
