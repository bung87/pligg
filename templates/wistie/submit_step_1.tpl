	...
	<div id="submit">
		<div id="submit_content">
			...
			<form action="{$URL_submit}" method="post" id="thisform">
				<label for="url">{#PLIGG_Visual_Submit1_NewsURL#}:<input class="" type="text" name="url" id="url" value="http://" size="55" /></label>
				...
				<input type="submit" value="{#PLIGG_Visual_Submit1_Continue#}" class="btn btn-primary submit-s" />
			</form>
			<br />
