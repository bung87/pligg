...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$('.stories').delegate('.linksummarySaveLink,.stories_status,.linksummaryRemoveLink','click',function(){
			...
			$('#leftcol').delegate('.stories','hover',function(){
				$(this).find('.storyfooter .floatleft').toggle();
			});
			...
			// $('.stories').delegate('.group_sharing','click',function(){
