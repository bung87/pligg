...
//		new Effect.Fade(target3);
	//unused	if (value > 0) { target2.innerHTML = "<span>" + PLIGG_Visual_Vote_Cast + "</span> "; }
	//by bung	else if (value < 0 ) { target2.innerHTML = "<span>" + PLIGG_Visual_Vote_Report + "</span> ";
...
function checkfield (type, form, field)
{
	...
	checkitxmlhttp.onreadystatechange = function () {
		...
		responsestring = checkitxmlhttp.responseText;
			...
			$('#'+field.name).tooltip('destroy');
			$('#'+field.name).tooltip({delay: { show: 500, hide: 100 },title:responsestring,placement:'right',trigger:'manual'});
			$('#'+field.name).tooltip('show');
