...
if(is_numeric($requestID)) {
	...
	$main_smarty->assign('voter', who_voted($id, 'large'));//change small to large by bung
	...
	//'link_summary2.tpl' add by bung
	$main_smarty->assign('the_story', $link->print_summary('full', true,'link_summary2.tpl'));
