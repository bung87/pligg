...
if($_POST["avatar"] == "uploaded")
{
	...
	$allowedFileTypes = array("image/jpg","image/jpeg","image/gif","image/png",'image/x-png','image/pjpeg');
	    //add image/jpg by bung
	unset($imagename);
	...
	{
		var_dump($_FILES['image_file']['type']);exit;
		$error['Type'] = 'Only these file types are allowed :jpg, jpeg, gif, png';
	}
